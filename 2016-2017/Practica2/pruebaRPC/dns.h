...
#define DNS1rename 2
extern  str_t * dns1rename_1(machine *, CLIENT *);
extern  str_t * dns1rename_1_svc(machine *, struct svc_req *);
...
#define DNS1rename 2
extern  str_t * dns1rename_1();
extern  str_t * dns1rename_1_svc();
...
#define DNS2rename 2
extern  str_t * dns2rename_1(machine *, CLIENT *);
extern  str_t * dns2rename_1_svc(machine *, struct svc_req *);
...
#define DNS2rename 2
extern  str_t * dns2rename_1();
extern  str_t * dns2rename_1_svc();
